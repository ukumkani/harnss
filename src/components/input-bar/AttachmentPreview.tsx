      ...
      {hasAttachments && (
        <div className="flex flex-wrap gap-2.5 px-5 pb-2.5">
          {attachments.map((att) => (
            <div
              key={att.id}
              className="group/att relative h-16 w-16 shrink-0 cursor-pointer overflow-hidden rounded-xl border border-foreground/30 shadow-sm ring-1 ring-inset ring-white/[0.04] transition-all duration-200 hover:shadow-md hover:border-border/50"
            ...
            >
              ...
              <div className="absolute bottom-0.5 end-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-background/90 text-foreground/65 opacity-0 shadow-sm transition-opacity group-hover/att:opacity-100">
              ...
              <Button
                ...
                className="absolute -end-1 -top-1 size-5 rounded-full bg-background/90 text-foreground/65 opacity-0 shadow-sm transition-opacity hover:bg-background/95 hover:text-foreground group-hover/att:opacity-100"
              >
                <X className="size-3" />
              </Button>
            </div>
          ...
          {grabbedElements.map((ge) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                {ge.textContent && (
                  <span className="max-w-48 truncate text-[10px] text-foreground/65">
              ...
              <Button
                ...
                className="absolute -end-1 -top-1 size-4 rounded-full bg-background/90 text-foreground/65 opacity-0 shadow-sm transition-opacity hover:bg-background/95 hover:text-foreground group-hover/grab:opacity-100"
              >
